...
public class TSA2ndMethod {
    public static void main(String[] args) {
        ...
        // int result = (int) tsa; // first convert the double value into integer data
        // type then store in any variable like result the print the result => Not
        // recommended to use this in TSA b/q value should be in double
